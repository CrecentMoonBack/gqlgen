...
type ComplexityRoot struct {
	Mutation struct {
		DeleteMessage func(childComplexity int, index int) int
		UpdateMessage func(childComplexity int, input string) int
	}
...
type MutationResolver interface {
	UpdateMessage(ctx context.Context, input string) (string, error)
	DeleteMessage(ctx context.Context, index int) (string, error)
}
...
type SubscriptionResolver interface {
	MessageStream(ctx context.Context) (<-chan string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.deleteMessage":
		...
		return e.complexity.Mutation.DeleteMessage(childComplexity, args["index"].(int)), true
	...
	case "Mutation.updateMessage":
		...
		return e.complexity.Mutation.UpdateMessage(childComplexity, args["input"].(string)), true
	...
	case "Subscription.messageStream":
		...
		return e.complexity.Subscription.MessageStream(childComplexity), true
...
func (ec *executionContext) field_Mutation_deleteMessage_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	arg0, err := ec.field_Mutation_deleteMessage_argsIndex(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["index"] = arg0
...
func (ec *executionContext) field_Mutation_deleteMessage_argsIndex(
	ctx context.Context,
...
func (ec *executionContext) _Mutation_updateMessage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().UpdateMessage(rctx, fc.Args["input"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_deleteMessage(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteMessage(rctx, fc.Args["index"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Subscription_messageStream(ctx context.Context, field graphql.CollectedField) (ret func(ctx context.Context) graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Subscription().MessageStream(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return nil
...
func (ec *executionContext) fieldContext_Subscription_messageStream(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Subscription",
		Field:      field,
		IsMethod:   true,
